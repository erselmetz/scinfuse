...
<div style="display:none;" id="scinfuse">
    ...
    <div class="lecture-modules-row">
        <div class="lecture-modules">
            <video controls>
                <source src="/Lectures/Physics/Videos/Current, Resistivity, and Electromotive Force.mp4" type="video/mp4">
            </video>
            <div class="lecture-modules-text">
                <h3><b>Current, Resistivity, and Electromotive Force</b></h3>
            </div>
