...
<body>
    ...
    <?php if(isset($_GET['subject'])){ ?>
        ...
        <div class="welcome-text1">
            <h1><?php echo divide_words($_GET['subject']) ?> Modules</h1>
        </div>

        <?php $sql="SELECT * FROM module WHERE subject_name='$subject_name' AND `status`='active'";
        $result = $db->query($sql);
            ...
            while ($row = $result->fetch_assoc()) { ?>
                ...
                <div class="modules-row">
                    <div class="modules">
                            ...
                            <a href="<?php echo "./read.php?type=module&subject=$row[subject_name]&id=$row[id]" ?>" class="button button13">Read</a>
                        </div>
                        <div class="credits">
