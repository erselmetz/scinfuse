...
function process(otherInput) {
    ...
    switch (text) {
        ...
        case "biologymodules":
			...
			case "module1":
            response = location.href = '../../Modules/Biology/Materials/The Role of Oxygen in Respiration and the Advantage and Disadvantage of Oxygen/The Role of Oxygen in Respiration and the Advantage and Disadvantage of Oxygen.php';
            return "The Role of Oxygen in Respiration and the Advantage and Disadvantage of Oxygen";
