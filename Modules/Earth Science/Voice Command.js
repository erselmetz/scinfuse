...
function process(otherInput) {
    ...
    switch (text) {
        ...
        case "earthmodules":
			...
			case "module2":
            response = location.href = '../../Modules/Earth Science/Materials/Earth and Earth's Subsystems/Earth and Earth's Subsystems.php';
            return "Earth and Earth's Subsystems";
