...
function process(otherInput) {
    ...
    switch (text) {
        ...
        case "storyboard":
			...
			case "read":
                return "Faith is a 51 years old BPO employee who goes up and down a footbridge on her way to work. She is in her third year of                         working graveyard shift. Faith recalled how she used to play volleyball and had a history of hip injury prior to                               working in a BPO. She was diagnosed to have osteoporosis. Her medications include calcium and vitamin D. Fractures of                         the spine caused by osteoporosis can lead to pain, loss of height and changes in posture, such as the ‘dowager’s                               hump’. This hump is caused when spinal fractures are compressed due to the force of gravity, resulting in an abnormal                         bending forward of the spine called kyphosis. Osteoporosis literally means ‘bones with holes’. It occurs when bones                           lose minerals such as calcium more quickly than the body can replace them. They become less dense, lose strength and                           break more easily.";
